...
public class NonPerishableGoodTemperatureOutOfRangeEvent {
	...
	public NonPerishableGoodTemperatureOutOfRangeEvent() {
		super();
	}

	public NonPerishableGoodTemperatureOutOfRangeEvent(long id,
			Double temperature, Long timestamp, String sensorID,
			String gatewayID, Double minimumRangeValue,
