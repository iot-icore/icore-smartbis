...
public class ObjectFactory {
    ...
    private final static QName _S06HVACActuatorStatus_QNAME = new QName("http://namespaces.softwareag.com/SmartBusiness", "S06_HVACActuatorStatus");
    private final static QName _S05CurrentClamp_QNAME = new QName("http://namespaces.softwareag.com/SmartBusiness", "S05_CurrentClamp");
    private final static QName _S03Humidity_QNAME = new QName("http://namespaces.softwareag.com/SmartBusiness", "S03_Humidity");
    ...
    private final static QName _TemperaturePrediciton_QNAME = new QName("http://namespaces.softwareag.com/EDA/SmartBusiness", "TemperaturePrediciton");
    ...
    /**
     * Create an instance of {@link S03HumidityType }
     * 
     */
    public S03HumidityType createS03HumidityType() {
        return new S03HumidityType();
    }

    /**
     * Create an instance of {@link S06HVACActuatorStatusType }
     * 
     */
    public S06HVACActuatorStatusType createS06HVACActuatorStatusType() {
        return new S06HVACActuatorStatusType();
    }

    /**
     * Create an instance of {@link S05CurrentClampType }
     * 
     */
    public S05CurrentClampType createS05CurrentClampType() {
        return new S05CurrentClampType();
    }
    ...
    /**
     * Create an instance of {@link TemperaturePredicitonType }
     * 
     */
    public TemperaturePredicitonType createTemperaturePredicitonType() {
        return new TemperaturePredicitonType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link S06HVACActuatorStatusType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://namespaces.softwareag.com/SmartBusiness", name = "S06_HVACActuatorStatus", substitutionHeadNamespace = "http://namespaces.softwareag.com/EDA/Event", substitutionHeadName = "Payload")
    public JAXBElement<S06HVACActuatorStatusType> createS06HVACActuatorStatus(S06HVACActuatorStatusType value) {
        return new JAXBElement<S06HVACActuatorStatusType>(_S06HVACActuatorStatus_QNAME, S06HVACActuatorStatusType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link S05CurrentClampType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://namespaces.softwareag.com/SmartBusiness", name = "S05_CurrentClamp", substitutionHeadNamespace = "http://namespaces.softwareag.com/EDA/Event", substitutionHeadName = "Payload")
    public JAXBElement<S05CurrentClampType> createS05CurrentClamp(S05CurrentClampType value) {
        return new JAXBElement<S05CurrentClampType>(_S05CurrentClamp_QNAME, S05CurrentClampType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link S03HumidityType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://namespaces.softwareag.com/SmartBusiness", name = "S03_Humidity", substitutionHeadNamespace = "http://namespaces.softwareag.com/EDA/Event", substitutionHeadName = "Payload")
    public JAXBElement<S03HumidityType> createS03Humidity(S03HumidityType value) {
        return new JAXBElement<S03HumidityType>(_S03Humidity_QNAME, S03HumidityType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TemperaturePredicitonType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://namespaces.softwareag.com/EDA/SmartBusiness", name = "TemperaturePrediciton", substitutionHeadNamespace = "http://namespaces.softwareag.com/EDA/Event", substitutionHeadName = "Payload")
    public JAXBElement<TemperaturePredicitonType> createTemperaturePrediciton(TemperaturePredicitonType value) {
        return new JAXBElement<TemperaturePredicitonType>(_TemperaturePrediciton_QNAME, TemperaturePredicitonType.class, null, value);
    }
