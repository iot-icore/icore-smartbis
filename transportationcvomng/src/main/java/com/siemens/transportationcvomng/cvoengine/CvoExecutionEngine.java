...
public interface CvoExecutionEngine {
	 ...
	 */
	public void addNewNonPerishableGoodsMonitoringEPN(String epnID, String packageID,
	 ...
	 */
	public void addNewTimeSeriesPredictionEPN(String epnID, String packageID, String gatewayID,
	...
	/**
	 * Generates the Graph describing the structure of EPN form CEP engine
	 * @return the graph
	 */
