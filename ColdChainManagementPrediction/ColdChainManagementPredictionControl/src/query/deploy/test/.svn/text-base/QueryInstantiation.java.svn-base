...
public class QueryInstantiation {
	...
	/**
	 * 
	 * @param queryID   	Unique Identifier for the started query. Necessary for stopping or adopting parameter like outputChannel
	...
	public void cancelQuery(String queryID) throws UnknownHostException{
