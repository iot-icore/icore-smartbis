...
public class DataConverter {
	 ...
	 * @param value a String object containing the value
	 ...
	 * @param value the String object to be parsed
	...
	/**
	 * Returns a double value based on the passed String; if the argument cannot be parsed, then Constants.NULL_OR_MISSING_VALUE
	 * @param value the String to be parsed
	 * @return parsed value as double, or Constants.NULL_OR_MISSING_VALUE if the given argument cannot be parsed
	 */
	 ...
	 * @param value a String object to be parsed
	 ...
	 * @param value he String object to be parsed
	 * @return a Long value
	 */
	...
	/**
	 * Parses the passed String value and returns a (possible null) XMLGregorianCalendar object
	 * @param value the String to be parsed
